...
LARGE_FONT_STYLE = ("Arial", 40, "bold")        #constant
SMALL_FONT_STYLE = ("Arial", 16)                #constant
DIGITS_FONT_STYLE = ("Arial", 24, "bold")       #constant
DEFAULT_FONT_STYLE = ("Arial", 20)              #constant
HISTORY_FONT_STYLE = ("Arial", 14)              #constant

OFF_WHITE = "#F8FAFF"
WHITE = "#FFFFFF"
LIGHT_BLUE = "#CCEDFF"
LIGHT_GRAY = "#F5F5F5"      #variable for bg color
LABEL_COLOR = "#25265E"     #constant
